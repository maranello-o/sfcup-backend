...
func newUsage(db *gorm.DB, opts ...gen.DOOption) usage {
	...
	_usage.usageDo.UseModel(&model.Usage{})
	...
	_usage.Model = field.NewString(tableName, "model")
	_usage.CreateTime = field.NewInt64(tableName, "create_time")
...
type IUsageDo interface {
	...
	Unscoped() IUsageDo
	Create(values ...*model.Usage) error
	CreateInBatches(values []*model.Usage, batchSize int) error
	Save(values ...*model.Usage) error
	First() (*model.Usage, error)
	Take() (*model.Usage, error)
	Last() (*model.Usage, error)
	Find() ([]*model.Usage, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Usage, err error)
	FindInBatches(result *[]*model.Usage, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Usage) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Usage, error)
	FirstOrCreate() (*model.Usage, error)
	FindByPage(offset int, limit int) (result []*model.Usage, count int64, err error)
...
func (u usageDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IUsageDo {
...
func (u usageDo) Create(values ...*model.Usage) error {
	if len(values) == 0 {
		return nil
	}
...
func (u usageDo) CreateInBatches(values []*model.Usage, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u usageDo) Save(values ...*model.Usage) error {
	if len(values) == 0 {
		return nil
	}
...
func (u usageDo) First() (*model.Usage, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Usage), nil
	}
}

func (u usageDo) Take() (*model.Usage, error) {
...
func (u usageDo) Last() (*model.Usage, error) {
...
func (u usageDo) Find() ([]*model.Usage, error) {
	result, err := u.DO.Find()
	return result.([]*model.Usage), err
}

func (u usageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Usage, err error) {
	buf := make([]*model.Usage, 0, batchSize)
...
func (u usageDo) FindInBatches(result *[]*model.Usage, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u usageDo) FirstOrInit() (*model.Usage, error) {
...
func (u usageDo) FirstOrCreate() (*model.Usage, error) {
...
func (u usageDo) FindByPage(offset int, limit int) (result []*model.Usage, count int64, err error) {
...
func (u usageDo) Delete(models ...*model.Usage) (result gen.ResultInfo, err error) {
