...
func InitGen() {
	...
	dataMap := map[string]func(columnType gorm.ColumnType) (dataType string){
		"tinyint":   func(columnType gorm.ColumnType) (dataType string) { return "bool" },
	...
	autoCreateTimeTag := field.NewGormTag()
	autoCreateTimeTag.Set("autoCreateTime", "")
	autoUpdateTimeTag := field.NewGormTag()
	autoUpdateTimeTag.Set("autoCreateTime", "")
	autoUpdateTimeField := gen.FieldGORMTag("update_time", func(tag field.GormTag) field.GormTag { return autoCreateTimeTag })
	autoCreateTimeField := gen.FieldGORMTag("create_time", func(tag field.GormTag) field.GormTag { return autoUpdateTimeTag })
